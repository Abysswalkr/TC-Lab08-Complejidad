...
from problem2 import function_p2, estimate_ops_p2
...
def main():
    ...
    results = run_profile(ns, function_p2, estimate_ops_p2, safe_skip=False)
    ...
    if xs:
        ...
        plt.title("Problema 2 – Tamaño de input vs. tiempo (seg)")
        plt.xlabel("n"); plt.ylabel("tiempo (s)"); plt.grid(True)
        out_png = Path(__file__).with_name("p2_demo.png")   # GUARDA EN "Problem 2"
